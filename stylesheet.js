...
function buildInvoiceHTML(inv, co, items, printMode = false) {
  ...
  const tableHead = printMode
    ? `<thead><tr><th>#</th><th>Product</th><th>HSN/SAC</th><th>Qty</th><th>Unit</th></tr></thead>`
    : `<thead><tr><th>#</th><th>Product</th><th>HSN/SAC</th><th>Qty</th><th>Unit</th><th>Amount</th></tr></thead>`;
